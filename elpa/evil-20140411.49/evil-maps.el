...
(define-key evil-motion-state-map "gk" 'elscreen-kill)
(define-key evil-normal-state-map "g0" 'elscreen-jump)
(define-key evil-normal-state-map "g1" 'elscreen-jump)
(define-key evil-normal-state-map "g2" 'elscreen-jump)
(define-key evil-normal-state-map "g3" 'elscreen-jump)
(define-key evil-normal-state-map "g4" 'elscreen-jump)
(define-key evil-normal-state-map "g5" 'elscreen-jump)
(define-key evil-normal-state-map "g6" 'elscreen-jump)
(define-key evil-normal-state-map "g7" 'elscreen-jump)
(define-key evil-normal-state-map "g8" 'elscreen-jump)
(define-key evil-normal-state-map "g9" 'elscreen-jump)
(define-key evil-normal-state-map "g." 'evil-ace-jump-word-mode)
(define-key evil-normal-state-map "g'" 'evil-ace-jump-char-mode)
